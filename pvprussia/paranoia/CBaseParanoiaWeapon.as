...
abstract class CBaseParanoiaWeapon: ScriptBasePlayerWeaponEntity{
    ...
    void MyTouch(CBaseEntity@ pOther){
        if(pOther.IsPlayer()){
            ...
            if(pPlayer.HasNamedPlayerItem(self.pev.classname) !is null){
                ...
                g_SoundSystem.EmitSoundDyn( pPlayer.edict(), CHAN_ITEM, "items/gunpickup2.wav", 0.8, ATTN_NORM, 0, PITCH_NORM );
            }
        }
    }
    ...
    void PrimaryAttack(){
        ...
        pPlayer.FireBullets(1, vecSrc, vecAiming, vecAcc, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, iDamage + int(Math.RandomFloat(vecDamageDrift.x, vecDamageDrift.y)), self.pev);
