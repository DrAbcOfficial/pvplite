class weapon_spas12 : CBaseParanoiaWeapon{
    ...
    void PrimaryAttack() override{
        ...
        pPlayer.FireBullets(iPellet, vecSrc, vecAiming, vecAcc, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, iDamage + int(Math.RandomFloat(vecDamageDrift.x, vecDamageDrift.y)), self.pev);
