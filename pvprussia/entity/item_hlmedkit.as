class item_hlmedkit : ScriptBasePlayerAmmoEntity
{
    ...
    { 
        ...
        g_EntityFuncs.SetModel( self, "models/sc_russian/w_pmedkit.mdl" );
    }
    
    void Precache()
    {
        BaseClass.Precache();
        g_Game.PrecacheModel("models/sc_russian/w_pmedkit.mdl");
        g_Game.PrecacheGeneric("models/sc_russian/w_pmedkit.mdl");
