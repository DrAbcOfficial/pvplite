...
class CSawedoff : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void PrimaryAttack()
	{
		...
		pPlayer.FireBullets( SAWEDOFF_SINGLE_PELLETCOUNTER, vecSrc, vecAiming, VECTOR_CONE_DM_SAWEDOFFS, 2048, BULLET_PLAYER_BUCKSHOT, 0,  pevAttacker:self.pev);
	...
	void SecondaryAttack()
	{
		...
		pPlayer.FireBullets( SAWEDOFF_DOUBLE_PELLETCOUNT, vecSrc, vecAiming, VECTOR_CONE_DM_SAWEDOFFD, 2048, BULLET_PLAYER_BUCKSHOT, 0,  pevAttacker:self.pev);
