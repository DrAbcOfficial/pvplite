...
class weapon_hl357 : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
    void Spawn()
    {
        Precache();
        g_EntityFuncs.SetModel( self, "models/hunger/w_hunger357.mdl" );
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "models/hunger/v_hunger357.mdl" );
        g_Game.PrecacheModel( "models/hunger/w_hunger357.mdl" );
        g_Game.PrecacheModel( "models/hunger/p_hunger357.mdl" );
    ...
    {
        self.pev.body = 1;
        return self.DefaultDeploy( self.GetV_Model( "models/hunger/v_hunger357.mdl" ), self.GetP_Model( "models/hunger/p_hunger357.mdl" ), PYTHON_DRAW, "python", 0, 1 );
    }
    ...
    void PrimaryAttack()
    {
        ...
        m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 0 , 40 ,pevAttacker:self.pev);
