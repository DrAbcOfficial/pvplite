...
class weapon_hlcrowbar : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
    int m_iSwing;
    TraceResult m_trHit;
    ...
    {
        self.Precache();
        g_EntityFuncs.SetModel( self, self.GetW_Model( "models/hunger/w_hungercrowbar.mdl") );
        self.m_iClip            = -1;
    ...
    void Precache()
    {
        ...
        g_Game.PrecacheModel( "models/hunger/v_hungercrowbar.mdl" );
        g_Game.PrecacheModel( "models/hunger/w_hungercrowbar.mdl" );
        g_Game.PrecacheModel( "models/hunger/p_hungercrowbar.mdl" );
    ...
    bool Deploy()
    {
        return self.DefaultDeploy( self.GetV_Model( "models/hunger/v_hungercrowbar.mdl" ), self.GetP_Model( "models/hunger/p_hungercrowbar.mdl" ), CROWBAR_DRAW, "crowbar" );
    }
