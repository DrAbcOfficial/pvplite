...
class CThompson : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void PrimaryAttack()
	{
		...
		pPlayer.FireBullets( 1, vecSrc, vecAiming, vecCone, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 4, m_iBulletDamage, self.pev);
