...
class CM14 : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void PrimaryAttack()
	{
		...
		{
			pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_5DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 4, m_iBulletDamage, self.pev);
		}
		else
		{
			pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 4, m_iBulletDamage, self.pev);
		}
