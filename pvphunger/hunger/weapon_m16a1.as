...
class CM16A1 : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	*/
	void FireABullet()
	{
		...
		m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_SAW, pevAttacker:self.pev);
