...
class CCrossbowBolt : ScriptBaseEntity
{
    ...
    void BoltTouch( CBaseEntity@ pOther )
    {
        ...
        if ( pOther.pev.takedamage > 0 )
        {
            ...
            if ( pOther.IsPlayer() )
            {
                pOther.TraceAttack( self.pev, 100, pev.velocity.Normalize(), tr, DMG_NEVERGIB );
            }
            else
            {
                pOther.TraceAttack( self.pev, 50, pev.velocity.Normalize(), tr, ( DMG_BULLET | DMG_NEVERGIB ) );
            }
            
            g_WeaponFuncs.ApplyMultiDamage( pev, self.pev );
    ...
    void ExplodeThink()
    {
        ...
        {
            CBaseEntity@ pevOwner = g_EntityFuncs.Instance( pev.owner );
            g_WeaponFuncs.RadiusDamage( vecExplodeOrigin, pev, self.pev, pev.dmg, 128, CLASS_NONE, ( DMG_BLAST | DMG_ALWAYSGIB ) );
        }
        else
        {
...
CCrossbowBolt@ BoltCreate(edict_t@ owner)
{
...
class weapon_hlcrossbow : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
    void Spawn()
    {
        Precache();
        g_EntityFuncs.SetModel( self, "models/w_crossbow.mdl" );
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "models/hunger/v_hungercrossbow.mdl" );
        g_Game.PrecacheModel( "models/w_crossbow.mdl" );
        g_Game.PrecacheModel( "models/p_crossbow.mdl" );
    ...
    {
        if ( self.m_iClip > 0 )
            return self.DefaultDeploy( self.GetV_Model( "models/hunger/v_hungercrossbow.mdl" ), self.GetP_Model( "models/p_crossbow.mdl" ), CROSSBOW_DRAW1, "bow" );
        return self.DefaultDeploy( self.GetV_Model( "models/hunger/v_hungercrossbow.mdl" ), self.GetP_Model( "models/p_crossbow.mdl" ), CROSSBOW_DRAW2, "bow" );
    }
    ...
    void FireSniperBolt()
    {
        ...
        if ( hit.pev.takedamage > 0 )
        {
            ...
            entity.TraceAttack( self.pev, 120, vecDir, tr, DMG_BULLET | DMG_NEVERGIB );
    ...
    void FireBolt()
    {
        ...
        CCrossbowBolt@ pBolt = BoltCreate(m_pPlayer.edict());
