...
class weapon_want_shotgun : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	int m_iShell;
	...
	void PrimaryAttack()
	{
		...
		{
			m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_DM_SHOTGUN, 8196, BULLET_PLAYER_CUSTOMDAMAGE, 0, m_iBulletDamage, pevAttacker:self.pev );
	...
	void SecondaryAttack()
	{
		...
		{
			m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_DM_DOUBLESHOTGUN, 8196, BULLET_PLAYER_CUSTOMDAMAGE, 0, m_iBulletDamage, pevAttacker:self.pev );
