...
class weapon_bow : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
...
class arrow : ScriptBaseEntity
{
	...
	void Precache()
	{
		g_Game.PrecacheModel( "models/wanted/arrow.mdl" );
	...
	void Touch( CBaseEntity@ pOther )
	{
		...
		if( pOther.pev.takedamage > DAMAGE_NO )
		{
			...
			pOther.TraceAttack( self.pev, ARROW_DMG, g_Engine.v_forward, tr, DMG_NEVERGIB );  
