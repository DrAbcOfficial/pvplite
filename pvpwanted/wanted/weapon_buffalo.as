...
class weapon_buffalo : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void PrimaryAttack()
	{
		...
		m_pPlayer.FireBullets( 1, vecSrc, vecAiming, self.m_fInZoom ? VECTOR_CONE_BUFFALO_ZOOMED : VECTOR_CONE_2DEGREES, 8196, BULLET_PLAYER_CUSTOMDAMAGE, 0, m_iBulletDamage, pevAttacker:self.pev );
