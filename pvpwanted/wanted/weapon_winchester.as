...
class weapon_winchester : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void Precache()
	{
		...
		g_SoundSystem.PrecacheSound( "wanted/weapons/winchester_dryfire.wav" ); // gun empty sound
	...
	bool PlayEmptySound()
	{
		if( self.m_bPlayEmptySound )
		{
			...
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "wanted/weapons/winchester_dryfire.wav", 0.8, ATTN_NORM, 0, PITCH_NORM );
		}
	...
	void PrimaryAttack()
	{
		...
		m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 0, m_iBulletDamage, pevAttacker:self.pev );
