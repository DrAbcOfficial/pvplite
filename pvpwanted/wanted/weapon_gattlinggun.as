...
class weapon_gattlinggun : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
	...
	void PrimaryAttack()
	{
		...
		else if( flSpinTime > 1.3f )
		{
			...
			{
				m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_20DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, m_iBulletDamage, pevAttacker:self.pev );
			}
			else if ( m_pPlayer.pev.flags & FL_DUCKING != 0 )
			{
				m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_5DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, m_iBulletDamage, pevAttacker:self.pev );
			}
			else
			{
				m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_2DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, m_iBulletDamage, pevAttacker:self.pev);
			}
