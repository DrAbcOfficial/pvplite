...
class dynamite : ScriptBaseMonsterEntity
{
	...
	void Explode( TraceResult pTrace, int bitsDamageType )
	{
        ...
        g_EntityFuncs.CreateExplosion( tr.vecEndPos, Vector( 0, 0, -90 ), self.pev.owner, int(pev.dmg), false ); // Effect
		g_WeaponFuncs.RadiusDamage( tr.vecEndPos, self.pev, self.pev, pev.dmg, pev.dmg * 2.5f, CLASS_NONE, bitsDamageType );
		...
		for( int i = 0; i < Math.RandomLong(0, 3); i++ ){
...
class weapon_dynamite : ScriptBasePlayerWeaponEntity, CBaseCustomWeapon
{
