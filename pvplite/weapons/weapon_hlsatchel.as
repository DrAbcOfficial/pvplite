...
class CSatchelCharge : ScriptBaseEntity
{
    void Spawn()
    {
        ...
        g_EntityFuncs.SetModel( self, "models/hlclassic/w_satchel.mdl" );
...
class weapon_hlsatchel : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "models/hlclassic/v_satchel.mdl" );
        g_Game.PrecacheModel( "models/hlclassic/w_satchel.mdl" );
        g_Game.PrecacheModel( "models/hlclassic/p_satchel.mdl" );
        
        g_Game.PrecacheModel( "models/hlclassic/v_satchel_radio.mdl" );
    ...
    bool Deploy()
    {
        ...
        if ( self.pev.iuser1 > 0 )
            return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_satchel_radio.mdl" ), self.GetP_Model( "models/hlclassic/p_satchel_radio.mdl" ), SATCHEL_RADIO_DRAW, "hive" );
        else
            return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_satchel.mdl" ), self.GetP_Model( "models/hlclassic/p_satchel.mdl" ), SATCHEL_DRAW, "trip" );
    }
    ...
    void Throw()
    {
        if ( m_pPlayer.m_rgAmmo( self.m_iPrimaryAmmoType ) > 0 )
        {
            ...
            m_pPlayer.pev.viewmodel = string( "models/hlclassic/v_satchel_radio.mdl" );
            m_pPlayer.pev.weaponmodel = string( "models/hlclassic/p_satchel_radio.mdl" );
    ...
    void WeaponIdle()
    {
        ...
        switch( self.pev.iuser1 )
        {
            ...
            case 2:
            {
                ...
                m_pPlayer.pev.viewmodel = string( "models/hlclassic/v_satchel.mdl" );
                m_pPlayer.pev.weaponmodel = string( "models/hlclassic/p_satchel.mdl" );
