...
class weapon_hlhandgrenade : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    {
        g_Game.PrecacheModel( "models/hlclassic/w_grenade.mdl" );
        g_Game.PrecacheModel( "models/hlclassic/v_grenade.mdl" );
    ...
    {
        m_flReleaseThrow = -1;
        return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_grenade.mdl" ), self.GetP_Model( "models/hlclassic/p_grenade.mdl" ), HANDGRENADE_DRAW, "crowbar" );
    }
