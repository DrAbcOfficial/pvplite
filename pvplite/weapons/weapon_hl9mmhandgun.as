...
class weapon_hl9mmhandgun : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    bool Deploy()
    {
        return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_9mmhandgun.mdl" ), self.GetP_Model( "models/hlclassic/p_9mmhandgun.mdl" ), GLOCK_DRAW, "onehanded" );
    }
    ...
    void GlockFire( float& in flSpread, float& in flCycleTime )
    {
        ...
        m_pPlayer.FireBullets( 1, vecSrc, vecAiming, Vector( flSpread, flSpread, flSpread ), 8192, BULLET_PLAYER_CUSTOMDAMAGE, 0 , 12, pevAttacker:self.pev);
        ...
        Vector vecDir = vecAiming 
                        + x * Vector( flSpread, flSpread, flSpread ).x * g_Engine.v_right 
                        + y * Vector( flSpread, flSpread, flSpread ).y * g_Engine.v_up;
...
void RegisterHL9mmhandgun()
{
    ...
    g_ItemRegistry.RegisterWeapon( GetHL9mmhandgunName(), "hl_weapons", "9mm" );
}
