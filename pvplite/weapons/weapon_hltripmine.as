...
const Vector COLOR_LASER(0, 250, 250);
...
class CTripmineGrenade : ScriptBaseMonsterEntity
{
    ...
    void Spawn()
    {
        ...
        g_EntityFuncs.SetModel( self, "models/hlclassic/v_tripmine.mdl" );
        self.pev.frame = 0;
        self.pev.body = 3;
        ...
        if ( !FNullEnt( self.pev.owner ) )
        {
            ...
            self.m_FormattedName = m_pRealOwner.vars.netname;
        }
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "models/hlclassic/v_tripmine.mdl" );
    ...
    void MakeBeam()
    {
        ...
        if ( eOwner !is null )
        {
            m_pBeam.SetColor( int(COLOR_LASER.x), int(COLOR_LASER.y), int(COLOR_LASER.z) );
        }
        else
...
class weapon_hltripmine : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    {
        Precache();
        g_EntityFuncs.SetModel( self, "models/hlclassic/w_tripmine.mdl" );
    ...
    bool Deploy()
    {
        return self.DefaultDeploy( "models/hlclassic/v_tripmine.mdl", "models/hlclassic/p_tripmine.mdl", TRIPMINE_DRAW, "trip" );
    }
