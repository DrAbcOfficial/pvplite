...
const Vector COLOR_TRAIL(250, 250, 250);
const Vector COLOR_DOT(250, 0 , 0);
...
class CLaserSpot : ScriptBaseEntity
{
    ...
    void Spawn()
    {
        ...
        self.pev.rendercolor = COLOR_DOT;
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "sprites/dot.spr" );
    }
...
CLaserSpot@ CreateSpot(CBasePlayer@ pPlayer)
{
...
class weapon_hlrpg : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    {
        Precache();
        g_EntityFuncs.SetModel( self, "models/hlclassic/w_rpg.mdl" );
    ...
    void Precache()
    {
        ...
        g_Game.PrecacheModel( "models/hlclassic/v_rpg.mdl" );
    ...
    bool Deploy()
    {
        if ( self.m_iClip == 0 )
        {
            return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_rpg.mdl" ), self.GetP_Model( "models/hlclassic/p_rpg.mdl" ), RPG_DRAW_UL, "rpg" );
        }
        
        return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_rpg.mdl" ), self.GetP_Model( "models/hlclassic/p_rpg.mdl" ), RPG_DRAW1, "rpg" );
    }
