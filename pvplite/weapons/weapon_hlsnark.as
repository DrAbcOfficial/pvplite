...
class CSqueakGrenade : ScriptBaseMonsterEntity
{
    ...
    void Spawn()
    {
        ...
        g_EntityFuncs.SetModel( self, "models/hlclassic/w_squeak.mdl" );
    ...
    void Precache()
    {
        g_Game.PrecacheModel( "models/hlclassic/w_squeak.mdl" );
        ...
        if ( eEnemy !is null )
        {
            ...
            switch( eEnemy.Classify() )
            {
                case CLASS_ALIEN_MILITARY: // Crimson
                {
                    ...
                    return CLASS_TEAM1; // No owner, attack everyone
                }
    ...
    void Killed( entvars_t@ pevAttacker, int iGib )
    {
        ...
        if ( m_hOwner )
        {
            ...
            if ( eOwner !is null )
                g_WeaponFuncs.RadiusDamage( pev.origin, pev, self.pev, pev.dmg, 40.0, CLASS_NONE, DMG_BLAST );
            else
        ...
        if ( pOther.pev.takedamage > 0 && self.m_flNextAttack < g_Engine.time )
        {
            ...
            if ( trace_pHit == pOther )
            {
                ...
                if ( trace_pHit.pev.modelindex != pev.modelindex )
                {
                    ...
                    pOther.TraceAttack( self.pev, 10, g_Engine.v_forward, tr, DMG_SLASH ); 
                    if ( eOwner !is null )
    ...
    CBaseEntity@ BestVisibleEnemy()
    {
        ...
        while( ( @pReturn = g_EntityFuncs.FindEntityInSphere( pReturn, self.pev.origin, 500.0, "*", "classname" ) ) !is null )
        {
            ...
            if( self.IRelationship( pReturn ) > ( R_NO ) && pReturn.IsAlive() && pReturn.edict() !is self.pev.owner)
                return pReturn;
...
class weapon_hlsnark : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    bool Deploy()
    {
        ...
        return self.DefaultDeploy( "models/hlclassic/v_squeak.mdl", "models/hlclassic/p_squeak.mdl", SQUEAK_UP, "squeak" );
    }
