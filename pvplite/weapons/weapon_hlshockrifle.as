...
class weapon_hlshockrifle : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    void Precache()
    {
        ...
        g_Game.PrecacheGeneric( "sprites/hl_weapons/weapon_hlshockrifle.txt" );
    ...
    void PrimaryAttack()
    {
        if( m_pPlayer.pev.waterlevel == WATERLEVEL_HEAD )
        {
            ...
            g_WeaponFuncs.RadiusDamage( self.GetOrigin(), self.pev, self.pev, (m_pPlayer.m_rgAmmo( self.m_iPrimaryAmmoType )) * 100, (m_pPlayer.m_rgAmmo( self.m_iPrimaryAmmoType )) * 150.0f, CLASS_NONE,  DMG_ALWAYSGIB | DMG_BLAST );
