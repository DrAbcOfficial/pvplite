...
class weapon_hlshotgun : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    void Precache()
    {
        ...
        m_iShell = g_Game.PrecacheModel( "models/hlclassic/shotgunshell.mdl" );// shotgun shell
    ...
    void CreatePelletDecals( const Vector& in vecSrc, const Vector& in vecAiming, const Vector& in vecSpread, const uint uiPelletCount )
    {
        ...
        g_EntityFuncs.EjectBrass( self.pev.origin + m_pPlayer.pev.view_ofs + g_Engine.v_up * -12 + g_Engine.v_forward * 32 + g_Engine.v_right * 6, vecShellVelocity, self.pev.angles.y, m_iShell, TE_BOUNCE_SHOTSHELL );
    }
    ...
    void PrimaryAttack()
    {
        ...
        m_pPlayer.FireBullets( 4, vecSrc, vecAiming, VECTOR_CONE_DM_SHOTGUN, 2048, BULLET_PLAYER_CUSTOMDAMAGE, 0 , 20, pevAttacker:self.pev);
    ...
    void SecondaryAttack()
    {
        ...
        m_pPlayer.FireBullets( 8, vecSrc, vecAiming, VECTOR_CONE_DM_DOUBLESHOTGUN, 2048, BULLET_PLAYER_CUSTOMDAMAGE, 0 , 20, pevAttacker:self.pev);
