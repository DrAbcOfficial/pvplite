...
class weapon_hlpenguin : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    void Precache()
    {
        ...
        g_Game.PrecacheModel( "sprites/hl_weapons/640hud7.spr" );
        g_Game.PrecacheModel( "sprites/hl_weapons/640hudof03.spr" );
        g_Game.PrecacheModel( "sprites/hl_weapons/640hudof04.spr" );
        
        g_Game.PrecacheGeneric( "sprites/hl_weapons/640hud7.spr" );
        g_Game.PrecacheGeneric( "sprites/hl_weapons/640hudof03.spr" );
        g_Game.PrecacheGeneric( "sprites/hl_weapons/640hudof04.spr" );
        
        g_Game.PrecacheGeneric( "sprites/hl_weapons/weapon_hlpenguin.txt" );
    ...
    void CustomTouch( CBaseEntity@ pOther )
    {
        ...
        if( pPlayer.HasNamedPlayerItem( "weapon_hlpenguin" ) !is null ) 
        {
            if( pPlayer.GiveAmmo( 1, "weapon_hlpenguin", 10 ) != -1 )
            {
                //self.CheckRespawn();
...
{    
    void Spawn()
    {
        ...
        CBaseEntity@ pEntity = g_EntityFuncs.CreateEntity( "weapon_hlpenguin", null, false );
...
string GetWeaponNamehlpenguinNade()
{
    return "weapon_hlpenguin";
}
void RegisterHLPenguinNade()
{
    RegisterDMPenguin();
    g_CustomEntityFuncs.RegisterCustomEntity( GetWeaponNamehlpenguinNade(), GetWeaponNamehlpenguinNade() );
    g_CustomEntityFuncs.RegisterCustomEntity( "weapon_penguin", "weapon_penguin" );
    g_ItemRegistry.RegisterWeapon( GetWeaponNamehlpenguinNade(), "hl_weapons", "penguin" );
    g_ItemRegistry.RegisterItem( GetWeaponNamehlpenguinNade(), "hl_weapons", "weapon_penguin" );
}