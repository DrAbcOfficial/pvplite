...
class weapon_hlcrowbar : ScriptBasePlayerWeaponEntity, CBasePVPWeapon
{
    ...
    void Precache()
    {
        ...
        g_Game.PrecacheModel( "models/hlclassic/v_crowbar.mdl" );
    ...
    bool Deploy()
    {
        return self.DefaultDeploy( self.GetV_Model( "models/hlclassic/v_crowbar.mdl" ), self.GetP_Model( "models/hlclassic/p_crowbar.mdl" ), CROWBAR_DRAW, "crowbar" );
    }
